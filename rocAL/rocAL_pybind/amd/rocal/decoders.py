...
def image_slice(*inputs,file_root='',path='',annotations_file='',shard_id = 0, num_shards = 1, random_shuffle = False, affine = True, axes = None, axis_names = "WH",bytes_per_sample_hint = 0, device_memory_padding = 16777216,
    ...
    if( reader == 'COCOReader'):
        ...
        kwargs_pybind = {
                ...
                "loop": False,
                "decode_size_policy": types.MAX_SIZE,
                "max_width": 2000, #TODO: what happens when we give user given size = multiplier * max_decoded_width
                "max_height":2000, #TODO: what happens when we give user given size = multiplier * max_decoded_width
                "area_factor": None,
                "aspect_ratio": None,
                "x_drift_factor": None,
                "y_drift_factor": None}
