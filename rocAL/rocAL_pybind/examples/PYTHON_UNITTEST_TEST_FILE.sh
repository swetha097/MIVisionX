...
do 
    ...
    do 
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name gamma_correction --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Gamma_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name contrast --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Contrast_${rgb_name[$rgb]}_${device_name}"
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name brightness --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Brightness_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name color_twist --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}ColorTwist_${rgb_name[$rgb]}_${device_name}"
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name fish_eye --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}FishEye_${rgb_name[$rgb]}_${device_name}"
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize_crop_mirror --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}ResizeCropMirror_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Resize_${rgb_name[$rgb]}_${device_name}_bilinear_default_FileReader"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name rotate --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Rotate_${rgb_name[$rgb]}_${device_name}"
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name color_temp --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}ColorTemp_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name blur --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Blur_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name hue --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Hue_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name saturation --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Saturation_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name snp_noise --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}SNPNoise_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name fog --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Fog_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name rain --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Rain_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name blend --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Blend_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize_crop --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}ResizeCrop_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name warp_affine --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}WarpAffine_${rgb_name[$rgb]}_${device_name}"
        # # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name jitter --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Jitter_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name snow --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Snow_${rgb_name[$rgb]}_${device_name}"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name center_crop --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}CropCenter_${rgb_name[$rgb]}_${device_name}" 
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize_mirror_normalize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}ResizeMirrorNormalize${rgb_name[$rgb]}_${device_name}" 
        # # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name vignette --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Vignette_${rgb_name[$rgb]}_${device_name}"
        # # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name pixelate --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb  --$backend_arg -f "${output_path}Pixelate_${rgb_name[$rgb]}_${device_name}"

        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb --interpolation-type 1 --scaling-mode 1 --$backend_arg -f "${output_path}Resize_${rgb_name[$rgb]}_${device_name}_bilinear_stretch_coco"
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb --interpolation-type 1 --scaling-mode 3 --$backend_arg -f "${output_path}Resize_${rgb_name[$rgb]}_${device_name}_bilinear_notlarger_tfDetection"
        ...
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb --interpolation-type 5 --scaling-mode 0 --$backend_arg -f "${output_path}Resize_${rgb_name[$rgb]}_${device_name}_triangular_default_caffe2Detection"
        # python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$image_path" --augmentation-name resize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb --interpolation-type 4 --scaling-mode 0 --$backend_arg -f "${output_path}Resize_${rgb_name[$rgb]}_${device_name}_gaussian_default_mxnet"
        ...
        python"$ver" rocAL_api_python_unittest.py --image-dataset-path "$tf_classification_path" --reader-type "tf_classification" --reader-type "tf_classification" --augmentation-name resize --batch-size $batch_size  --max-width $width --max-height $height --color-format $rgb --interpolation-type 1 --scaling-mode 2 --$backend_arg -f "${output_path}Resize_${rgb_name[$rgb]}_${device_name}_bilinear_notsmaller_tfClassification"
