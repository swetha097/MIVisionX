...
def parse_args():
    parser = ArgumentParser(description="To parse args for unit tests")
    ...
    common_group.add_argument('--no-display', default=False, action="store_true",
                        help='--no-display:to display output from the pipeline')
    common_group.add_argument('--no-print_tensor', default=False, action="store_true",
                        help='--no-print_tensor: to print tensor output from the pipeline')
    common_group.add_argument('--no-classification', default=False, action="store_true",
                        help='--no-classification: to use for detection pipeline')
    common_group.add_argument('--no-rocal-gpu', default=False, action="store_true",
                        help='--no-rocal-gpu to use cpu backend')
    common_group.add_argument('--no-NHWC', default=False, action='store_true',
